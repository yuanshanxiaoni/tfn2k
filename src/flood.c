...
void syn (unsigned long victim, unsigned short port) {
    struct sa sin;
...
void icmp (unsigned long lamer, unsigned long src) {
    struct sa pothead;
    struct ip *iph;
    struct icmp *icmph;
    char *packet;
...
void targa3 (unsigned long victim) {
